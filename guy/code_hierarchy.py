...
bias_points=[0,1]#-0.02] # Start and finish bias current in units of the increment
...
for pdex in range(startpdex,endpdex+1):  
    ...
    for i in range(0, toplim):
      ...
      for bias in range(bias_points[0],bias_points[1]):
        ...
        print myProject.elecInputInfo.getStim("Bias")
        ...
        for k in range(0,len(cell_str)):
          ...
          #instr=inmod
          print cell_str[k]
          myProject.generatedElecInputs.addSingleInput(inmod,'RandomSpikeTrain','MF_3D_Small',cell_str[k],0,0,None)  
