...
he tradeoff between performance and added usefulness seems in favour
of using a pure rate code, at least in the first stage as we use a
rate-coded input.
*** level of inhibition
*** input pattern correlation
** Technical upgrades needed 
*** Simulation features
**** TODO Check that GrC and synaptic model actually correspond to the latest version from Rothman and Piasini 2013.
**** TODO Change the tonic inhibition from being a current to being a conductance.
