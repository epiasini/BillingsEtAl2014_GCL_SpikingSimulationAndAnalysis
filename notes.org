...
***** DONE Test how many cores I can actually use on the cluster
      ...
      - CLOSING NOTE [2013-11-20 Wed 10:03] \\
        It seems I can get about _238 cores_.
...
*** TODO frequency response of the GrC model to synaptic stimulation
    ...
    I think the correct way of going about this would be to look at
    the autocorrelation function of the spike train (or voltage trace)
    produced by the cell model under Poisson stimulation at different
    rates.
...
*** TODO inhibition: decide on the (fixed) level of tonic GABA conductance
*** TODO mf -> grc synapses: decide if total conductance should scale inversely with the number of dendrites.
...
**** DONE Change the tonic inhibition from being a current to being a conductance.
     ...
     - CLOSING NOTE [2013-11-22 Fri 16:59] \\
       ...
       inhibitory current.
**** TODO If the simulation time is short, should the variables in the synaptic plasticity mechanisms be initialised at their steady state value for the given stimulation frequency?
**** TODO Implement Guy's network connection algorithm
