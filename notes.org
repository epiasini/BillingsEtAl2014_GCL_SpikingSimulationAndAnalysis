...
**** DONE +Implement Guy's network connection algorithm+
     ...
     #+END_QUOTE
**** TODO [1/1] Reduce maximum number of files used by a complete run through of the workflow.
     - [X] Make sure nC garbage gets cleaned up before a simulation job exits.
