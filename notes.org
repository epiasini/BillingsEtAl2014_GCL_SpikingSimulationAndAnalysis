...
**** DONE Make a simple f-f curve for the GrC model with 4 dendrites.
     ...
     - CLOSING NOTE [2013-11-29 Fri 14:21] \\
       This curve, showing the response of the cell to Poisson
       stimulation by 4 mossy fiber terminals firing at various rates,
       has been produced with rev [[magit:~/phd/nC_projects/GranCellRothmanIf/::commit@7260f5d][GranCellRothmanIf.git
       commit #7260f5d]] in the granule cell model repo.
     [[file:fig/rate_IO.png][file:fig/rate_IO.png]]
**** TODO Make a comparison between my f-f curve and what Jason had in Schwartz2012.
...
**** TODO Implement sparsity measure.
     Try playing around with a properly normalised version of the
     Treves-Rolls sparsity measure (ie the Hoyer sparsity measure) and
     what Willmore and Tolhurst (2001) call 'activity sparseness'.
