...
**** TODO Fix csv export of glomerular positions in Guy's mathematica notebook.
...
**** TODO Take info on number of cells from archive metadata and not from size of spike tables.
**** TODO Add dimension to analysis parameter space to represent integration window length.
**** TODO Remove saving of all rates to results archives before running with big network
