...
**** DONE Implement importer for text-based network descriptions.
     ...
     - CLOSING NOTE [2013-12-08 Sun 19:05] \\
       ...
       structure configurations.  The figures below show a 3D view
       (made with the [[file:scripts/visualise_network.py::filename%20%3D%20'/home/ucbtepi/code/network/data/network_structures/gd4/GCLconnectivity_full.graphml'][mayavi-based network visualisation script]]) and a
       (x, y) projection (made with Gephi) of an instantiation of the
       network with 4 dendrites. Also shown is a map of the number of
       degrees of separation between one granule node (in red) and the
       other nodes. A correlation between euclidean and separation
       distance is evident.
       #+ATTR_HTML: :width 60%
       [[file:fig/tissue_model_3d_gd4.png][file:~/phd/code/network/src/fig/tissue_model_3d_gd4.png]]
       #+ATTR_HTML: :width 60%
       [[file:fig/tissue_model_gd4.png][file:~/phd/code/network/src/fig/tissue_model_gd4.png]]
       #+ATTR_HTML: :width 60%
       [[file:fig/tissue_model_distance_from_gr_gd4.png][file:~/phd/code/network/src/fig/tissue_model_distance_from_gr_gd4.png]]
