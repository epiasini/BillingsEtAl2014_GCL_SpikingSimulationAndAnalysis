...
**** DONE Implement inverse scaling of excitatory conductance with number of dendrites.
     ...
     number of dendrites.
**** TODO Separate the DTA parameter from the control of how inhibition scales with the number of dendrites.
