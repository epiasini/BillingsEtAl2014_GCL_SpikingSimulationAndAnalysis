...
*** TODO frequency response of the GrC model to synaptic stimulation
    ...
    Also, I should have a look at how Guy explains the 30ms assumption
    in the paper.
...
**** TODO Make a table of all the parameters in the model, noting where each of them comes from.
**** TODO Make a simple f/f curve for the GrC model with 4 dendrites.
